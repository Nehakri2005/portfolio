      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <p className="text-xl font-bold">Neha Kumari</p>
            <p className="text-gray-400">Full Stack Development</p>
          </div>
          <div className="flex space-x-6">
            <a href="https://github.com/Nehakri2005" className="hover:text-blue-400 transition" aria-label="GitHub">
            ...
            <a href="https://www.linkedin.com/in/neha-kumari-659025273/" className="hover:text-blue-400 transition" aria-label="LinkedIn">
              <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-8 text-center text-gray-400 text-sm">
          <p>© 2025 Neha Kumari. All rights reserved.</p>
